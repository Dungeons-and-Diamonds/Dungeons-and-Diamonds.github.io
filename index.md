...
{% include button.html text="Join us on Discord" icon="discord" link="https://discord.dndmc.net" color="#7289DA" %} {% include button.html text="View the Map" icon="map" link="http://map.dndmc.net" color="#0d94e7" %} {% include button.html text="Visit our Store" link="http://store.dndmc.net" color="#333333" %} {% include button.html text="Become a Patreon" icon="patreon" link="http://patreon.dndmc.net" color="#E64413" %}
